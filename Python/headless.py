...
#font = ImageFont.truetype(font="/home/pi/Documents/Engineering_4_Notebook/slkscr.ttf")
...
while  True:
	...
	draw.text((0,0), 'edges=',font=font, fill=255)
	draw.text((0,10), '12ms^2',font=font, fill=255)
